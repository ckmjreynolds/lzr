...
enum Command {
    ...
    Bench {
        ...
        corpus: PathBuf,
        /// Codec name. v7 knows: `null`, `cmix`, `lmix`, `lmatch`, `lsse`, `lword`, `lhi`, `ldict`, `lnn`, `lnndict`, `lrnn`, `lrnndict`, `lgru`, `lgrudict`, `lind`, `linddict`, `lall`, `lindcase`, `linddictcase`, `lindcasemode`, `lallmode`.
